...
## **수칙 한 줄이 찢겨 나간다** (밤 7 03:00). 이 게임의 간판 사건인데 무음이었다 —
## 줄이 **붙을** 때는 종이 소리가 나는데 뜯겨 나갈 때는 아무 소리도 안 났다.
##
## 붙는 소리(`paper`)보다 길고 낮고 거칠다. 종이를 놓는 것과 찢는 것은 다른 동작이다.
static func tear() -> AudioStreamWAV:
	return tone(140.0, 0.42, 7.0, 0.96, false, 0.30)
