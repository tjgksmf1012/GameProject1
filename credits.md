...
캐릭터 초상 8종, 타이틀 점포 배경, CCTV 4채널 아틀라스는 OpenAI의 내장 이미지 생성
도구로 2026-08-19에 이 프로젝트를 위해 제작한 사전 생성 래스터 원화다. 실존 브랜드,
상표, 저작권 캐릭터, 특정 작가 이름을 프롬프트에 사용하지 않았다.

파일별 용도와 최종 프롬프트는 `docs/art/GENERATED-ASSETS.md`에 기록한다. 이 원화는
